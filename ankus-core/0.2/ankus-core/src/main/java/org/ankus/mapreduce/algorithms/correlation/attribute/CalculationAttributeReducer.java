 ...
 * @author Suhyun Jeon
*/
public class CalculationAttributeReducer extends Reducer<TextTwoWritableComparable, TextIntegerTwoPairsWritableComparable, TextTwoWritableComparable, DoubleWritable> {
    ...
    protected void reduce(TextTwoWritableComparable key, Iterable<TextIntegerTwoPairsWritableComparable> values, Context context) throws IOException, InterruptedException {
        ...
        if(algorithmOption.equals(Constants.HAMMING_DISTACNE)){
