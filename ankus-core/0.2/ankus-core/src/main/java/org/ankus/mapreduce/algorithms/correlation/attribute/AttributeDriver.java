...
import org.ankus.util.AnkusUtils;import org.ankus.util.ArgumentsConstants;import org.ankus.util.Constants;import org.ankus.util.HadoopUtil;import org.ankus.util.Usage;import org.apache.hadoop.conf.Configuration;
...
import java.lang.Exception;import java.lang.String;import java.lang.System;import java.net.URI;
 ...
 * @author Suhyun Jeon
*/
public class AttributeDriver extends Configured implements Tool {
    ...
    // SLF4J Logging
    private Logger logger = LoggerFactory.getLogger(AttributeDriver.class);

    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new AttributeDriver(), args);
        System.exit(res);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        job1 = HadoopUtil.prepareJob(job1, new Path(input), prepareOutputPath, AttributeDriver.class,
                AttributeMapper.class, NullWritable.class, Text.class,
                AttributeReducer.class, NullWritable.class, TextIntegerTwoPairsWritableComparable.class);
...
//        job2 = HadoopUtil.prepareJob(job2, prepareOutputPath, new Path(output), AttributeDriver.class,
//                CalculationAttributeMapper.class, TextTwoWritableComparable.class, TextIntegerTwoPairsWritableComparable.class,
//                CalculationAttributeReducer.class, TextTwoWritableComparable.class, DoubleWritable.class);
//
